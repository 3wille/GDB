...
\item Ein Erzähler muss mindestens einem Zuhörer einen oder mehrere Witze erzählen.
\item Ein Witz enthält eine Pointe, die aber nur vermittelt werden kann, wenn ein Witz erzählt wird.

\end{itemize}
\item
\begin{itemize}
\item Minimal kann ein Erzähler einem Zuhörer keinmal einen WItz erzählen.
\item Maximal kann ein Erzähler einem Zühörer uendliche viele Witze erzählen bwz. so viele wie er kennt.
\end{itemize}
\item
\begin{itemize}
...
\item
\begin{itemize}
\item Eine Straße hat einen eindeutigen Namen.
\item In der Staße können beliebig vile Häuser stehen, jedes Haus jedoch nur in einer Straße und auch nur wenn eine Straße gibt.
\item Jedes Haus hat eine Hausnummer, die sich von anderen Hausnummern in der gleichen Straße unterscheidet.
\end{itemize}
\end{enumerate}
